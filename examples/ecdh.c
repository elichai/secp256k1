...
int main(void) {
    ...
    memclear(seckey1, sizeof(seckey1));
    memclear(seckey2, sizeof(seckey2));
    memclear(shared_secret1, sizeof(shared_secret1));
    memclear(shared_secret2, sizeof(shared_secret2));
